...
| Default Division | 본인 부서 (예: `HE`)                          |
| Default Team     | 본인 팀 (예: `CAE`)                           |
...
```
GET /api/records?tag=IGA&division=HE&year=2026
```
...
### 7.5 "메타 폼에 Division/Team 옵션이 안 뜬다"
...
| 내가 올린 자료 통계           | `GET /api/analytics/distribution?division=HE&team=CAE`   |
