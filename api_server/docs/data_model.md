...
AI Data Hub는 사업부 문서/데이터를 PostgreSQL 에 적재하고
...
| 데이터 종류 | 예시 ID                            |
|-------------|------------------------------------|
| 가이드 문서 | `DOC-HE-CAE-2026-000001`           |
| 측정 데이터 | `DATA-HE-CAE-2026-000018`          |
| 시뮬레이션  | `SIM-HE-CAE-2026-000045`           |
...
| records          | `idx_records_div_team`                    | 사업부/팀 필터                       |
...
예: GET /figures/DOC-HE-CAE-2026-000001/F001.png
```
...
```json
{
  ...
  "caption":     "Figure 1: ...",
  "section_ref": "1.2",
  "image_path":  "DOC-HE-CAE-2026-000001/F001.png"
}
```
