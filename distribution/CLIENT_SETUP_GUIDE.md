...
| **사업부 엔지니어** (비개발자) | 자기 부서 자료 적재 (`.docx/.xlsx/.pptx/.pdf/.md/.html`) — **GUI 선호** | **VS Code Extension** (`vscode_extension/ai-data-hub-uploader-0.6.0.vsix`) |
...
- 위치: [`vscode_extension/ai-data-hub-uploader-0.6.0.vsix`](./vscode_extension/ai-data-hub-uploader-0.6.0.vsix)
