...
| [`vscode_extension/`](./vscode_extension/) | **VS Code Extension (GUI)** — `ai-data-hub-uploader-0.6.0.vsix` (38.05 KB) + USER_GUIDE.md. 비개발자 친화 5-step Webview (DropZone → Form → Send). 비개발 사업부 엔지니어가 자료 적재할 때. |
...
| **사업부 엔지니어** (GUI) | vsix 설치 | `vscode_extension\ai-data-hub-uploader-0.6.0.vsix` (자세한 사용법 [`USER_GUIDE.md`](./vscode_extension/USER_GUIDE.md)) |
