...
**예시**: "DOC-HE-CAE-2026-0000000001 이거랑 비슷한 자료 있어?"
...
### 시나리오 2: "이 문서 요약해줘 (DOC-HE-CAE-2026-0000000001)"

```
User: DOC-HE-CAE-2026-0000000001 문서 요약해줘
LLM:  get_record("DOC-HE-CAE-2026-0000000001")
...
```
User: DOC-HE-CAE-2026-0000000001 이거랑 비슷한 거 더 보여줘
LLM:  find_related("DOC-HE-CAE-2026-0000000001", mode="auto")
